...
let goku    :persDragBallZ =new persDragBallZ("./Goku",    "Goku"   , 90 , 540, false); // false superSaiyajin
let vegueta :persDragBallZ =new persDragBallZ( "./Vegueta","Vegueta", 85 , 550, false);
let broly   :persDragBallZ =new persDragBallZ("./Broly",   "Broly"  , 100, 510, false);
let ironMan :persMarvel = new persMarvel     ("./Ironman", "IronMan", 75 , 600,    20);  
let hulk    :persMarvel = new persMarvel     ("./Hulck" ,  "Hulk"   , 95 , 600,   20);
let thor    :persMarvel = new persMarvel     ("./Thor"   , "Thor"   , 90 , 500,   20);
...
function validarEleccion( ){// Sevalida la elecccion de los personajes
